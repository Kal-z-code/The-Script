...
cost_plot <- ggplot(edu_cost_table) +
  aes(x = education, y = `mean(total_cost)`, fill = education) +
  geom_col() +
  scale_fill_viridis_d(option = "viridis", direction = 1) +
  labs(
    y = "mean",
    title = "Average total cost of treatment across education"
  ) +
  theme_minimal()+ theme(
...
```{r}
# Save your plot(s)
ggsave(here("outputs/cost_plot.png"), plot = cost_plot, width = 10, height = 8, dpi = 300)
```
